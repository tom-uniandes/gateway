...
if os.environ.get("URL_ANALITICA"):
    url_base_analitica = os.environ.get("URL_ANALITICA")
...
logger.info(f"URL ANALITICA: {url_base_analitica}")
...
def post_logout():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling, url_base_auth_api + "/auth/logout",
                                                         COMUNNICATION_SYNC)
...
def get_verify_authorization():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                         url_base_auth_api + "/auth/verify-authorization",
                                                         COMUNNICATION_SYNC)
...
def post_create_client():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                         url_base_manejo_clientes + "/clients/create_client",
                                                         COMUNNICATION_SYNC)
...
def get_client(id):
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                         url_base_manejo_clientes + f"/clients/get_client/{id}",
                                                         COMUNNICATION_SYNC)
...
def get_incidents(client):
    if incidents_on_local:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/get_incidents/{client}",
                                                             COMUNNICATION_SYNC)
    else:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/get_incidents/{client}",
                                                             COMUNNICATION_INCIDENT)
...
def get_user(id, client):
    if incidents_on_local:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/get_user/{id}/{client}",
                                                             COMUNNICATION_SYNC)
    else:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/get_user/{id}/{client}",
...
def get_incident(id, client):
    if incidents_on_local:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/get_incident/{id}/{client}",
                                                             COMUNNICATION_SYNC)
    else:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/get_incidents/{id}/{client}",
                                                             COMUNNICATION_INCIDENT)
...
def create_user():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                         url_base_incidents + f"/incidents/create_user",
                                                         COMUNNICATION_SYNC)
...
def create_incident():
    if incidents_on_local:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/create_incident",
                                                             COMUNNICATION_SYNC)
    else:
        return ExceptionHandling.communicate_to_microservice(ExceptionHandling,
                                                             url_base_incidents + f"/incidents/create_incident",
                                                             COMUNNICATION_INCIDENT, EVENT_INCIDENTS)
...
def get_node():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling, url_base_chatbot_api + "/getnode",
                                                         COMUNNICATION_SYNC)


@app.route('/getsolutions', methods=['GET'])
def get_solutions():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling, url_base_chatbot_api + "/getsolutions",
                                                         COMUNNICATION_SYNC)
...
def get_incidents():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling, url_base_incidents + "/incidents",
                                                         COMUNNICATION_INCIDENT)


@app.route('/report-incident', methods=['POST'])
def post_incident():
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling, url_base_incidents + "/incident",
                                                         COMUNNICATION_INCIDENT)


@app.route('/report-incident/<id>', methods=['GET', 'PUT', 'DELETE'])
def actions_incident(id):
    return ExceptionHandling.communicate_to_microservice(ExceptionHandling, url_base_incidents + f"/incident/{id}",
                                                         COMUNNICATION_INCIDENT)
